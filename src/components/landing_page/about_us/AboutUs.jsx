...
const AboutUs = () => {
  ...
  const imgs = {
    1: [{ pic: richelle, role: titles[0], name: "Richelle Ross" }, {pic: matthew, role: titles[0], name: "Matthew Potter"} ],
    // 2: { },
    2: [{ pic: michael, role: titles[1], name: "Michael Chrupcala" }, { pic: teddy, role: titles[1], name: "Teddy Ngo" }], 
    // 4: ,
    3: [{ pic: quinton, role: titles[1], name: "Quinton McNamee" }, { pic: edwin, role: titles[1], name: "Edwin Parker" }, { pic: marcus, role: titles[1], name: "Marcus Jones" }],
    // 6: ,
    // 7: ,
    4: [{ pic: jay, role: titles[2], name: "Jay Jacobsohn" }, { pic: samuel, role: titles[2], name: "Samuel Hepner" }, { pic: john, role: titles[2], name: "John Morrison" }],
    // 9: ,
    // 10: ,
  ...
  <div
    ...
    <div className="landing-content2">
      <button className="carousel-button" onClick={() => handleCount("back")}>back</button>
      ...
      {imgs[count].map(i => (
        ...
        <button className="carousel-button" onClick={() => handleCount("forward")}>forward</button>
